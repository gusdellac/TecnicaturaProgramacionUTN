...
# 3 Lista de palabras que apparecen en la segunda lista, pero no en la primera
...
print(f"Lista de palabras que apparecen en la segunda lista, pero no en la primera: {solo2}")
