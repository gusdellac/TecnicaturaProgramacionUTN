...
Vamos a hacer en esta clase algunas operaciones de: suma, resta, multiplicación, división
"""
class Aritmetica:
    def __init__(self, operandoA, operandoB):
        self.operandoA = operandoA  #atributo de instancia o método
        self.operandoB = operandoB  #atributo de instancia o método
